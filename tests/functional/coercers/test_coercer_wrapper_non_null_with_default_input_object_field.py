...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.wrapperNonNullWithDefaultInputObjectField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            None,
            {"data": {"wrapperNonNullWithDefaultInputObjectField": "SUCCESS"}},
        ),
        (
            """query { wrapperNonNullWithDefaultInputObjectField(param: null) }""",
            None,
            {
                "data": {
                    "wrapperNonNullWithDefaultInputObjectField": "SUCCESS-None"
                }
            },
        ),
        (
            """query { wrapperNonNullWithDefaultInputObjectField(param: {}) }""",
            None,
            {
                "data": {
                    "wrapperNonNullWithDefaultInputObjectField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """
            query {
              wrapperNonNullWithDefaultInputObjectField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: WrapperNonNullWithDefaultMyInput) { wrapperNonNullWithDefaultInputObjectField(param: $param) }""",
            None,
            {"data": {"wrapperNonNullWithDefaultInputObjectField": "SUCCESS"}},
        ),
        (
        ...
        (
            """query ($param: WrapperNonNullWithDefaultMyInput = null) { wrapperNonNullWithDefaultInputObjectField(param: $param) }""",
            None,
            {
                "data": {
                    "wrapperNonNullWithDefaultInputObjectField": "SUCCESS-None"
        ...
        (
            """query (
              ...
              wrapperNonNullWithDefaultInputObjectField(param: $param)
            }""",
            None,
            {"data": {"wrapperNonNullWithDefaultInputObjectField": "SUCCESS"}},
        ),
...
async def test_coercer_wrapper_non_null_with_default_input_object_field(
