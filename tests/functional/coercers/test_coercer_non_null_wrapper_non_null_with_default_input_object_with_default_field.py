...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            """query { nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField(param: null) }""",
            None,
            {
                "data": {
        ...
        (
            """query { nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField(param: {}) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """
            query {
              nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: WrapperNonNullWithDefaultMyInput) { nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """query ($param: WrapperNonNullWithDefaultMyInput = null) { nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullWithDefaultInputObjectWithDefaultField": None
...
async def test_coercer_non_null_wrapper_non_null_with_default_input_object_with_default_field(
