...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.nonNullWrapperNonNullInputObjectWithDefaultField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectWithDefaultField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """query { nonNullWrapperNonNullInputObjectWithDefaultField(param: null) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectWithDefaultField": None
                },
                "errors": [
                    {
        ...
        (
            """query { nonNullWrapperNonNullInputObjectWithDefaultField(param: {}) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectWithDefaultField": None
        ...
        (
            """
            query {
              nonNullWrapperNonNullInputObjectWithDefaultField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: WrapperNonNullMyInput) { nonNullWrapperNonNullInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """query ($param: WrapperNonNullMyInput = null) { nonNullWrapperNonNullInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectWithDefaultField": None
        ...
        (
            """query (
              ...
              nonNullWrapperNonNullInputObjectWithDefaultField(param: $param)
            }""",
            None,
            {
                "data": {
...
async def test_coercer_non_null_wrapper_non_null_input_object_with_default_field(
