...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.nonNullInnerNonNullInputObjectWithDefaultField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "data": {
                    "nonNullInnerNonNullInputObjectWithDefaultField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """query { nonNullInnerNonNullInputObjectWithDefaultField(param: null) }""",
            None,
            {
                "data": {
                    "nonNullInnerNonNullInputObjectWithDefaultField": None
                },
                "errors": [
                    {
        ...
        (
            """query { nonNullInnerNonNullInputObjectWithDefaultField(param: {}) }""",
            None,
            {
                "data": {
                    "nonNullInnerNonNullInputObjectWithDefaultField": None
        ...
        (
            """
            query {
              nonNullInnerNonNullInputObjectWithDefaultField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: InnerNonNullMyInput) { nonNullInnerNonNullInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullInnerNonNullInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """query ($param: InnerNonNullMyInput = null) { nonNullInnerNonNullInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "nonNullInnerNonNullInputObjectWithDefaultField": None
        ...
        (
            """query (
              ...
              nonNullInnerNonNullInputObjectWithDefaultField(param: $param)
            }""",
            None,
            {
                "data": {
...
async def test_coercer_non_null_inner_non_null_input_object_with_default_field(
