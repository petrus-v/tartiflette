...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.nonNullWrapperNonNullInputObjectField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            """
            query {
              nonNullWrapperNonNullInputObjectField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            ...
            {
                "data": {
                    "nonNullWrapperNonNullInputObjectField": "SUCCESS-"
                    "[booleanField:False]-"
        ...
        (
            """query (
              ...
              nonNullWrapperNonNullInputObjectField(param: $param)
            }""",
            None,
            {"data": {"nonNullWrapperNonNullInputObjectField": "SUCCESS"}},
        ),
        (
            """query (
              $param: WrapperNonNullMyInput = {
...
async def test_coercer_non_null_wrapper_non_null_input_object_field(
