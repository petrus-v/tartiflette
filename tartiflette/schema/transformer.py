...
def parse_operation_type_definition(
    ...
    setattr(
        schema,
        f"{operation_type_definition_node.operation_type}_type",
...
def parse_scalar_type_definition(
    ...
    schema.add_custom_scalar_definition(scalar_type)
    schema.add_definition(scalar_type)
    return scalar_type
...
def parse_object_type_definition(
    ...
    schema.add_definition(object_type)
    return object_type
...
def parse_interface_type_definition(
    ...
    schema.add_definition(interface_type)
...
def parse_enum_type_definition(
    ...
    schema.add_definition(enum_type)
    return enum_type
...
def parse_input_object_type_definition(
    ...
    schema.add_definition(input_object_type)
